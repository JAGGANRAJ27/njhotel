        ...
        <div class="auth_container">
            <div id="Log_in">
                ...
                <form class="user_login authsection active" id="userlogin" action="" method="POST">
                    ...
                    <div class="footer_line">
                        <h6>Don't have an account? <span style="color:#FF5714;cursor:pointer;" onclick="signuppage()">sign up</span></h6>
                    </div>
                </form>
            ...
            <div id="sign_up">
                ...
                <form class="user_signup" id="usersignup" action="" method="POST">
                    ...
                    <div class="footer_line">
                        <h6>Already have an account? <span style="color:#FF5714;cursor:pointer;" onclick="loginpage()">Log in</span></h6>
                    </div>
                </form>
            </div>
    </section>
